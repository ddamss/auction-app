...
<div class="container">
                ...
                <div class="panel-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-2" id="edit"> <span class="glyphicon glyphicon-edit"
                                    class="btn btn-primary" id="btn-edit"></span> </div>
                            <div class="clearfix"></div>
                            <div class="bot-border"></div>
                    ...
                    <div style="margin: auto;text-align: center;"><button type="button" class="btn btn-danger"
                            id="delete">Delete account</button></div>
                </div>
            </div>
    ...
    window.onload = function(e) {
        ...
        newEditBtn.addEventListener("click", function(e) {
            ...
            window.axios.put('http://127.0.0.1/auction-app/public/api/buyer/' + Number(user_id), {
                    deposit_amount_val
                }, {
                    headers: {
